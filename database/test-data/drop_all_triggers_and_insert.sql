-- Drop all custom triggers on maid_profiles and insert test data
-- This is a temporary fix to allow test data insertion
...
-- Insert into maid_profiles with explicit profile_completion_percentage
