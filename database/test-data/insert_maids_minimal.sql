-- Minimal Test Maid Data
-- Inserts only into auth.users (minimal fields), profiles, and maid_profiles

-- Step 1: Insert into auth.users with minimal required fields
