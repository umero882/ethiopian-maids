...
const filePath = path.join(__dirname, '../src/pages/dashboards/agency/AgencySponsorsPage.jsx');
...
console.log('✅ Fixed agencyId to use user.id instead of user.agency_id');
